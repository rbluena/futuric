...
import { LayoutManager, ContentWrapper, Header, Head } from '@app/components';

const Privacy = () => (
  <LayoutManager>
    <Head title="Privacy" />
    <Header />
    <ContentWrapper id="md_en" data-target="out_en" className="agreement_md">
      <div className="pb-4">
        <h1 className="text-3xl py-4 border-b border-neutral-300">
          Privacy Policy
        </h1>
        <p className="text-lg leading-8 font-bold italic">
      ...
      <h2 className="text-2xl py-2">Interpretation</h2>
      <p className="text-lg leading-8">
      ...
      <h2 className="text-2xl py-2">Definitions</h2>
      <p className="text-lg leading-8">
      ...
      <ul className="list-outside pl-6 text-lg py-4 list-disc">
        ...
        <li className="pl-2 py-2">
          <p className="text-lg leading-8">
            <strong>Website</strong> refers to Asteyo, accessible from{' '}
            <a
              href="https://asteyo.com"
      ...
      <h3 className="text-xl font-bold py-3">Personal Data</h3>
      <p className="text-lg leading-8">
      ...
      <ul className="list-outside pl-6 text-lg py-4 list-disc">
        <li className="pl-2 py-2">
          <p className="text-lg leading-8">Email address</p>
        </li>
        <li className="pl-2 py-2">
          <p className="text-lg leading-8">First name and last name</p>
        </li>
        <li className="pl-2 py-2">
          <p className="text-lg leading-8">Usage Data</p>
        </li>
      </ul>
      <h3 className="text-xl font-bold py-3">Usage Data</h3>
      <p className="text-lg leading-8">
      ...
      <ul className="list-outside pl-6 text-lg py-4 list-disc">
        <li className="pl-2 py-2">
          ...
          <p className="text-lg leading-8">Type: Session Cookies</p>
          <p className="text-lg leading-8">Administered by: Us</p>
          <p className="text-lg leading-8">
        ...
        <li className="pl-2 py-2">
          ...
          <p className="text-lg leading-8">Type: Persistent Cookies</p>
          <p className="text-lg leading-8">Administered by: Us</p>
          <p className="text-lg leading-8">
      ...
      <h2 className="text-2xl py-2">Use of Your Personal Data</h2>
      <p className="text-lg leading-8">
      ...
      <h2 className="text-2xl py-2">Retention of Your Personal Data</h2>
      <p className="text-lg leading-8">
      ...
      <h2 className="text-2xl py-2">Transfer of Your Personal Data</h2>
      <p className="text-lg leading-8">
      ...
      <h2 className="text-2xl py-2">Disclosure of Your Personal Data</h2>
      <h3 className="text-xl font-bold py-3">Business Transactions</h3>
      <p className="text-lg leading-8">
      ...
      <h3 className="text-xl font-bold py-3">Law enforcement</h3>
      <p className="text-lg leading-8">
        Under certain circumstances, the Company may be required to disclose
        Your Personal Data if required to do so by law or in response to valid
        requests by public authorities (e.g. a court or a government agency).
      </p>
      <h3 className="text-xl font-bold py-3">Other legal requirements</h3>
      <p className="text-lg leading-8">
        The Company may disclose Your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul className="list-outside pl-6 text-lg py-4 list-disc">
        <li className="pl-2 py-2">Comply with a legal obligation</li>
        <li className="pl-2 py-2">
        ...
        <li className="pl-2 py-2">Protect against legal liability</li>
      </ul>
      <h2 className="text-2xl py-2">Security of Your Personal Data</h2>
      <p className="text-lg leading-8">
      ...
      <ul className="list-outside pl-6 text-lg py-4 list-disc">
        <li className="pl-2 py-2">By email: info@asteyo.com</li>
      </ul>
    </ContentWrapper>
  </LayoutManager>
);
