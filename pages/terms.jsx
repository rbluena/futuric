...
const Terms = () => (
  <ContentWrapper>
    ...
    <p className="text-lg leading-8 font-bold italic">Updated at 2021-01-17</p>

    <h1 className="text-3xl py-4 border-b border-neutral-300">General Terms</h1>
    <p className="text-lg leading-8">
      By accessing and placing an order with <b>Asteyo</b>, you confirm that you
      ...
      and any email or other type of communication between you and Asteyo.
    </p>
    <p className="text-lg leading-8">
    ...
    <p className="text-lg leading-8">
      ...
      &quot;we&quot; or &quot;our&quot;), the provider of the Asteyo website and
      the services accessible from the Asteyo website (which are collectively
      referred to in these Terms & Conditions as the &quot;Asteyo
      Service&quot;).
    </p>
    <p className="text-lg leading-8">
    ...
    <ul className="list-outside pl-6 text-lg py-4 list-disc">
      ...
      <li className="pl-2 py-2">
        <b>Country:</b> where Asteyo or the owners/founders of Asteyo are based,
        in this case is TZ
      </li>
      <li className="pl-2 py-2">
      ...
      <li className="pl-2 py-2">
        <b>Service:</b> refers to the service provided by Asteyo as described in
      ...
      <li className="pl-2 py-2">
        <b>Website:</b> Asteyo&apos;s site, which can be accessed via this URL:
        https://asteyo.com
      </li>
      <li className="pl-2 py-2">
        <b>You:</b> a person or entity that is registered with Asteyo to use the
        Services.
      </li>
    </ul>

    <h1 className="text-3xl py-4 border-b border-neutral-300">Restrictions</h1>
    <p className="text-lg leading-8">
    ...
    <ul className="list-outside pl-6 text-lg py-4 list-disc">
      ...
      <li className="pl-2 py-2">
        ...
        copyright or trademark) of Asteyo or its affiliates, partners, suppliers
    ...
    <p className="text-lg leading-8">
      Thanks for shopping at Asteyo. We appreciate the fact that you like to buy
    ...
    <p className="text-lg leading-8">
      ...
      to transactions at Asteyo. We’ll be as brief as our attorneys will allow.
      The main thing to remember is that by placing an order or making a
      purchase at Asteyo, you agree to the terms along with Asteyo&apos;s
      Privacy Policy.
    </p>
    <p className="text-lg leading-8">
    ...
    <p className="text-lg leading-8">
      ...
      &quot;Suggestions&quot;) provided by you to Asteyo with respect to the
      website shall remain the sole and exclusive property of Asteyo.
    </p>
    <p className="text-lg leading-8">
    ...
    <h1 className="text-3xl py-4 border-b border-neutral-300">Your Consent</h1>
    <p className="text-lg leading-8">
    ...
    <p className="text-lg leading-8">
      ...
      you or to users generally at Asteyo’s sole discretion, without prior
      notice to you. You may stop using the Service at any time. You do not need
      to specifically inform Asteyo when you stop using the Service. You
      acknowledge and agree that if Asteyo disables access to your account, you
    ...
    <p className="text-lg leading-8">
      ...
      aspect thereof. Asteyo does not assume and shall not have any liability or
    ...
    <p className="text-lg leading-8">
      Asteyo may, in its sole discretion, at any time and for any or no reason,
    ...
    <p className="text-lg leading-8">
      ...
      fees, due to or arising out of your: (a) use of the website; (b) violation
      of this Agreement or any law or regulation; or (c) violation of any right
      of a third party.
    </p>

    <h1 className="text-3xl py-4 border-b border-neutral-300">No Warranties</h1>
    <p className="text-lg leading-8">
      The website is provided to you &quot;AS IS&quot; and &quot;AS
      AVAILABLE&quot; and with all faults and defects without warranty of any
      kind. To the maximum extent permitted under applicable law, Asteyo, on its
      ...
      website, including all implied warranties of merchantability, fitness for
      ...
      practice. Without limitation to the foregoing, Asteyo provides no warranty
    ...
    <p className="text-lg leading-8">
      ...
      or e-mails sent from or on behalf of Asteyo are free of viruses, scripts,
    ...
    <p className="text-lg leading-8">
      ...
      Asteyo and any of its suppliers under any provision of this Agreement and
    ...
    <p className="text-lg leading-8">
      ...
      even if Asteyo or any supplier has been advised of the possibility of such
    ...
    <h1 className="text-3xl py-4 border-b border-neutral-300">Severability</h1>
    <p className="text-lg leading-8">
    ...
    <p className="text-lg leading-8">
      ...
      agreement between you and Asteyo concerning the Services. If any provision
      ...
      Asteyo&apos;s failure to assert any right or provision under this
      Agreement shall not constitute a waiver of such right or provision. YOU
      AND Asteyo AGREE THAT ANY CAUSE OF ACTION ARISING OUT OF OR RELATED TO THE
    ...
    <p className="text-lg leading-8">
      ...
      any time thereafter nor shall be the waiver of a breach constitute waiver
    ...
    <p className="text-lg leading-8">
      ...
      to the new terms, you are no longer authorized to use Asteyo.
    </p>
    ...
    <p className="text-lg leading-8">
      ...
      use or purchase other Asteyo&apos;s services, which Asteyo will provide to
    ...
    <p className="text-lg leading-8">
      ...
      owned by Asteyo, its licensors or other providers of such material and are
      protected by TZ and international copyright, trademark, patent, trade
      ...
      written permission of Asteyo, unless and except as is expressly provided
    ...
    <p className="text-lg leading-8">
      ...
      between you and Asteyo concerning the Services or this agreement, whether
      in contract, warranty, tort, statute, regulation, ordinance, or any other
    ...
    <p className="text-lg leading-8">
      ...
      become the sole property of Asteyo without any compensation or credit to
      you whatsoever. Asteyo and its affiliates shall have no obligations with
    ...
    <p className="text-lg leading-8">
      Asteyo may, from time to time, include contests, promotions, sweepstakes,
    ...
    <h1 className="text-3xl py-4 border-b border-neutral-300">Miscellaneous</h1>
    <p className="text-lg leading-8">
      ...
      if in writing and signed by an authorized representative of Asteyo. Asteyo
      ...
      anticipatory breach by you. Asteyo operates and controls the Asteyo
      Service from its offices in TZ. The Service is not intended for
      distribution to or use by any person or entity in any jurisdiction or
      country where such distribution or use would be contrary to law or
      regulation. Accordingly, those persons who choose to access the Asteyo
      ...
      incorporate the Asteyo Privacy Policy) contains the entire understanding,
      and supersedes all prior understandings, between you and Asteyo concerning
    ...
    <p className="text-lg leading-8">
      Asteyo is not responsible for any content, code or any other imprecision.
    </p>
    <p className="text-lg leading-8">
    ...
    <p className="text-lg leading-8">
      ...
      exercises no editorial control over such content and makes no warranty or
      ...
      accessible via the Asteyo Service. Without limiting the foregoing, Asteyo
      specifically disclaims all warranties and representations in any content
      transmitted on or in connection with the Asteyo Service or on sites that
      may appear as links on the Asteyo Service, or in the products provided as
      a part of, or otherwise in connection with, the Asteyo Service, including
      without limitation any warranties of merchantability, fitness for a
      particular purpose or non-infringement of third party rights. No oral
      advice or written information given by Asteyo or any of its affiliates,
      ...
      notice. Without limiting the foregoing, Asteyo does not warrant that the
      Asteyo Service will be uninterrupted, uncorrupted, timely, or error-free.
    </p>
